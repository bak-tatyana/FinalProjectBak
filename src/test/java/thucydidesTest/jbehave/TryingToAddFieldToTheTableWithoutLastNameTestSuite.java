...
*/
public class TryingToAddFieldToTheTableWithoutLastNameTestSuite extends ThucydidesJUnitStory {
    public TryingToAddFieldToTheTableWithoutLastNameTestSuite() throws InterruptedException {
        super();
